...
### Paso 3
Se seleccionó Image -> 
Adjust -> Color Treshold y con la ventana emergente se buscó el filtro adecuado tal que se pintara la hoja completa.
```{r}
...
```
### Paso 4
Con el filtro correcto el procedimiento siguiente era: Analize -> Analize Particles y en la ventana emergente:
 - Size (1-Infinity)
 - Show (Masks)
```{r}
